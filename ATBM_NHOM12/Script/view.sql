...
/
grant select, update(DT) on ADPRO.QLHS_TTCANHAN to RL_NVCOBAN; -- Grant select on sinh vien, don vi, hoc phan, khmo
...
-- Như CS1
/
grant select, update(DT) on ADPRO.QLHS_TTCANHAN to RL_GIANGVIEN; -- Grant select on sinh vien, don vi, hoc phan, khmo
...
GRANT SELECT, UPDATE(DIEMTH, DIEMQT, DIEMCK, DIEMTK) ON  
                    ADPRO.QLHS_DANGKY_HPGD TO RL_GIANGVIEN;
/
--CS3 : giao vu
-- Như CS1
