...
END;
/
CREATE OR REPLACE PROCEDURE ADPRO.USP_CREATEUSER_NVCOBAN
AS
 CURSOR CUR IS (SELECT MANV
 FROM ADPRO.NHANSU
 WHERE VAITRO = 'NVCOBAN' AND MANV NOT IN (SELECT USERNAME
 FROM ALL_USERS)
 );
 STRSQL VARCHAR(2000);
 USR VARCHAR2(5);
...
END;
/
CREATE OR REPLACE PROCEDURE ADPRO.USP_CREATEUSER_GIANGVIEN
AS
 CURSOR CUR IS (SELECT MANV
 FROM ADPRO.NHANSU
 WHERE VAITRO = 'GIANGVIEN' AND MANV NOT IN (SELECT USERNAME
 FROM ALL_USERS)
 );
 STRSQL VARCHAR(2000);
 USR VARCHAR2(5);
...
END;
/
CREATE OR REPLACE PROCEDURE ADPRO.USP_CREATEUSER_GIAOVU
AS
 CURSOR CUR IS (SELECT MANV
 FROM ADPRO.NHANSU
 WHERE VAITRO = 'GIAOVU' AND MANV NOT IN (SELECT USERNAME
 FROM ALL_USERS)
 );
 STRSQL VARCHAR(2000);
 USR VARCHAR2(5);
...
END;
/
CREATE OR REPLACE PROCEDURE ADPRO.USP_CREATEUSER_TRUONGDV
AS
 CURSOR CUR IS (SELECT MANV
 FROM ADPRO.NHANSU
 WHERE VAITRO = 'TRUONGDV' AND MANV NOT IN (SELECT USERNAME
 FROM ALL_USERS)
 );
 STRSQL VARCHAR(2000);
 USR VARCHAR2(5);
...
END;
/
CREATE OR REPLACE PROCEDURE ADPRO.USP_CREATEUSER_TRUONGKHOA
AS
 CURSOR CUR IS (SELECT MANV
 FROM ADPRO.NHANSU
 WHERE VAITRO = 'TRUONGKHOA' AND MANV NOT IN (SELECT USERNAME
 FROM ALL_USERS)
 );
 STRSQL VARCHAR(2000);
 USR VARCHAR2(5);
...
/
begin
    ADPRO.USP_CREATEUSER_NVCOBAN;
    ADPRO.USP_CREATEUSER_GIANGVIEN;
    ADPRO.USP_CREATEUSER_GIAOVU;
    ADPRO.USP_CREATEUSER_TRUONGDV;
    ADPRO.USP_CREATEUSER_TRUONGKHOA;
    ADPRO.USP_CREATEUSER_SINHVIEN;   
end; 

exec ADPRO.USP_CREATEUSER_NVCOBAN;